    ...
    <div class="container">
      <div class="feature-content">
        <div class="feature-text">
          ...
          <p>Monitor your websites 24/7 with intervals as low as 15 seconds. Get instant notifications when your site goes down.</p>
        ...
        <div class="feature-image">
          <img src="https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg" alt="Uptime Monitoring Dashboard">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="feature-content reverse">
        <div class="feature-text">
          ...
          <p>Never let your SSL certificates expire. Get advance notifications and ensure your website remains secure.</p>
          <ul class="feature-list">
        ...
        <div class="feature-image">
          <img src="https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg" alt="SSL Certificate Monitoring">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="feature-content">
        <div class="feature-text">
          ...
          <p>Monitor your website's performance with detailed response time analytics and alerts for slow loading times.</p>
          <ul class="feature-list">
        ...
        <div class="feature-image">
          <img src="https://images.pexels.com/photos/48727/pexels-photo-48727.jpeg" alt="Response Time Analytics">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="feature-section alternate" id="domain">
    <div class="container">
      <div class="feature-content reverse">
        ...
        <div class="feature-image">
          <img src="https://images.pexels.com/photos/1591060/pexels-photo-1591060.jpeg" alt="Domain Monitoring">
        </div>
      </div>
    </div>
  </section>
